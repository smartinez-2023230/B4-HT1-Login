...
Delimiter $$
	create procedure sp_create_users(in name_p varchar(50), lastname_p varchar(50), email_p varchar(50), user_p varchar(20), password_p varchar(35))
	begin
...
call sp_create_users("John","MySQL","JohnMySQL@gmail.com","TheRealJohnMySQL","123");